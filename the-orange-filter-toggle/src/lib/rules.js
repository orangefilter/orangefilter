...
export function generateRules(lists, settings = {}) {
  ...
  // In reverse mode (Lock Him Up), skip URL blocking entirely.
  // We WANT to reach pages — DOM filtering handles showing only matching content.
  if (settings.filterMode === 'lockhimup') {
    return [];
  }
